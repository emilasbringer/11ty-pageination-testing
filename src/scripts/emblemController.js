...
*/
if(rank=="Iron") {
    displayImageURL = emblems[0];
}
if(rank=="Bronze") {
    displayImageURL = emblems[1];
}
if(rank=="Silver") {
    displayImageURL = emblems[2];
}
if(rank=="Gold") {
    displayImageURL = emblems[3];
}
if(rank=="Platinum") {
    displayImageURL = emblems[4];
}
if(rank=="Diamond") {
    displayImageURL = emblems[5];
}
if(rank=="Master") {
    displayImageURL = emblems[6];
}
if(rank=="Grandmaster") {
    displayImageURL = emblems[7];
}
if(rank=="Challenger") {
